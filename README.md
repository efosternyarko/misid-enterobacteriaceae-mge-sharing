...
- [`protocol.qmd`](protocol.qmd) — the full analysis protocol (Quarto document), covering environment setup, assembly QC and species re-identification, typing and annotation, AMR/plasmid detection, the inter-species MGE-sharing network analysis, plasmid-borne ARG confirmation, and species-specific virulence characterisation. Rendered version: **https://efosternyarko.github.io/misid-enterobacteriaceae-mge-sharing/**. Re-render locally with `quarto render protocol.qmd`.
...
> Liu, C.K. Genomic characterisation of misidentified clinical Enterobacteriaceae isolates: inter-species mobile genetic element sharing. Analysis protocol. Available at: https://efosternyarko.github.io/misid-enterobacteriaceae-mge-sharing/ (source: https://github.com/efosternyarko/misid-enterobacteriaceae-mge-sharing).
